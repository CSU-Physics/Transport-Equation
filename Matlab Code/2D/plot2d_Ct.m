...
legend1 = [num2str(txt1) '(' num2str(txt1_x) ',' num2str(txt1_y) ')'];
legend2 = [num2str(txt2) '(' num2str(txt2_x) ',' num2str(txt2_y) ')'];
legend3 = [num2str(txt3) '(' num2str(txt3_x) ',' num2str(txt3_y) ')'];

%Fig_t = figure;
plot(t,C1,t,C2,t,C3,'LineWidth',2);
legend(legend1,legend2,legend3,'Interpreter','LaTex','FontSize',18);
