% 2d plots
function Fig_t = plot3d_Ct(t,tmax,C_t,C_t_min,C_t_max,labels,flag,fig_title,fig_txt)
Nt = length(t);
tlab = labels(1);
Clab = labels(2);
...
C1(1:Nt) = C_t(1,1,1,1:Nt);
C2(1:Nt) = C_t(2,2,2,1:Nt);
C3(1:Nt) = C_t(3,3,3,1:Nt);
...
legend1 = [num2str(txt1) '(' num2str(txt1_x) ',' num2str(txt1_y) ',' num2str(txt1_z) ')'];
legend2 = [num2str(txt2) '(' num2str(txt2_x) ',' num2str(txt2_y) ',' num2str(txt2_z) ')'];
legend3 = [num2str(txt3) '(' num2str(txt3_x) ',' num2str(txt3_y) ',' num2str(txt3_z) ')'];

%Fig_t = figure;
plot(t,C1,t,C2,t,C3,'LineWidth',2);
legend(legend1,legend2,legend3,'Interpreter','LaTex','FontSize',14);

%title('Pollution concentration at A, B \& C','Interpreter','LaTex','FontSize',14);
